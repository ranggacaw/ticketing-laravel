...
<div class="max-w-4xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
    <div class="mb-8 flex items-center justify-between">
        ...
        <a href="{{ route('admin.dashboard') }}" class="flex items-center gap-2 text-app-secondary hover:text-indigo-400 transition-colors text-sm font-medium">
    ...
    <div class="glass-card rounded-3xl overflow-hidden">
        <form action="{{ route('admin.users.store') }}" method="POST" class="p-8 md:p-12 space-y-10">
            ...
            <div class="pt-8 flex items-center justify-end gap-4">
                <a href="{{ route('admin.dashboard') }}" class="px-8 py-4 rounded-2xl border border-black/5 dark:border-white/10 text-app-secondary hover:text-app-primary hover:bg-black/5 dark:hover:bg-white/5 transition-all font-bold cursor-pointer">
                    Cancel
                </a>
