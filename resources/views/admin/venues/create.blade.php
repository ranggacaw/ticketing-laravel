    ...
    <div class="space-y-8 animate-in fade-in duration-700 max-w-4xl mx-auto">
        <div class="flex items-center justify-between">
            <div>
                ...
                <h2 class="text-2xl sm:text-3xl font-bold tracking-tight">Add New <span class="gradient-text">Venue</span>
                </h2>
                <p class="text-slate-400 mt-1 font-light text-sm">Define the location and capacity details.</p>
            </div>
        </div>
            ...
            <form action="{{ route('admin.venues.store') }}" method="POST" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    <div class="col-span-2">
                        <label for="name" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Venue
                            Name</label>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea name="description" id="description" rows="3"
                            class="w-full rounded-xl border-slate-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 focus:border-indigo-500 focus:ring-indigo-500 transition-colors"
                            placeholder="Optional description about the venue...">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-rose-500">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div>
                        <label for="city"
                            class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">City</label>
                    ...
                    <div>
                        <label for="state" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">State /
                            Province</label>
                    ...
                    <div>
                        <label for="country"
                            class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Country</label>
                    ...
                    <div>
                        <label for="postal_code"
                            class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Postal Code</label>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="capacity" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Max
                            Capacity</label>
