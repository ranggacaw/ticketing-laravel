                ...
                <div class="space-y-2">
                    ...
                    <div class="relative group">
                        ...
                        <select name="type" id="type" required
                            ...
                            <option value="General Admission" {{ old('type', $ticket->type) == 'General Admission' ? 'selected' : '' }} class="bg-white ">General Admission</option>
                            <option value="Festival" {{ old('type', $ticket->type) == 'Festival' ? 'selected' : '' }} class="bg-white ">Festival</option>
                            <option value="VIP" {{ old('type', $ticket->type) == 'VIP' ? 'selected' : '' }} class="bg-white ">VIP</option>
                            <option value="VVIP" {{ old('type', $ticket->type) == 'VVIP' ? 'selected' : '' }} class="bg-white ">VVIP</option>
                        </select>
