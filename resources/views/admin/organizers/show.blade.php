        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-1 space-y-8">
                <div class="glass-card p-6 rounded-3xl border-black/5 dark:border-white/10 shadow-sm">
                    <h3 class="text-lg font-semibold text-slate-900 dark:text-white mb-4">Contact Info</h3>

                    <div class="space-y-4">
                        <div>
                            <span class="text-xs font-semibold text-slate-400 uppercase tracking-wider">Email</span>
                            <p class="text-slate-700 dark:text-slate-300 mt-1 break-all">{{ $organizer->email }}</p>
                        </div>
                        ...
                        @if($organizer->phone)
                            <div class="pt-4 border-t border-black/5 dark:border-white/5">
                                ...
                                <p class="text-slate-700 dark:text-slate-300 mt-1">{{ $organizer->phone }}</p>
                            </div>
                        @endif
            ...
            <div class="lg:col-span-2 space-y-8">
                <h3 class="text-xl font-bold text-slate-900 dark:text-white">Events ({{ $organizer->events->count() }})</h3>
                ...
                <div class="glass-card rounded-3xl overflow-hidden border-black/5 dark:border-white/10 shadow-sm">
                    ...
                    @else
                        <div class="flex flex-col items-center justify-center py-16 text-center">
                            <div
                                class="w-12 h-12 bg-slate-100 dark:bg-white/5 rounded-full flex items-center justify-center text-slate-400 mb-3">
                                <svg class="h-6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                </svg>
                            </div>
                            <p class="text-slate-900 dark:text-slate-300 font-medium">No events yet</p>
